...
pub const LOGICAL_OR: u8 = 21;
pub const EQ: u8 = 22;
pub const NEQ: u8 = 23;
pub const LESS: u8 = 24;
pub const LESS_EQUAL: u8 = 25;
pub const GREATER: u8 = 26;
pub const GREATER_EQUAL: u8 = 27;
pub const PRINT: u8 = 28;
pub const DEFINE_GLOBAL: u8 = 29;
pub const DEFINE_LOCAL: u8 = 30;
pub const SET_GLOBAL: u8 = 31;
pub const SET_LOCAL: u8 = 32;
pub const PUSH_GLOBAL: u8 = 33;
pub const PUSH_LOCAL: u8 = 34;
...
pub fn to_string(code: u8) -> String {
    match code {
        ...
        18 => "DIV".to_owned(),
        19 => "MOD".to_owned(),
        20 => "LOGICAL_AND".to_owned(),
        21 => "LOGICAL_OR".to_owned(),
        22 => "EQ".to_owned(),
        23 => "NEQ".to_owned(),
        24 => "LESS".to_owned(),
        25 => "LESS_EQUAL".to_owned(),
        26 => "GREATER".to_owned(),
        27 => "GREATER_EQUAL".to_owned(),
        28 => "PRINT".to_owned(),
        29 => "DEFINE_GLOBAL".to_owned(),
        30 => "DEFINE_LOCAL".to_owned(),
        31 => "SET_GLOBAL".to_owned(),
        32 => "SET_LOCAL".to_owned(),
        33 => "PUSH_GLOBAL".to_owned(),
        34 => "PUSH_LOCAL".to_owned(),
